...
class TwigExtension extends AbstractExtension {
  ...
  public function getFunctions() {
    ...
    return [
      new TwigFunction('get_entity', [$this, 'getEntity']),
      new TwigFunction('get_field', [$this, 'getField']),
      new TwigFunction('get_block', [$this, 'getBlock']),
      new TwigFunction('get_block_content', [$this, 'getBlockContent']),
      new TwigFunction('get_block_plugin', [$this, 'getBlockPlugin']),
      ...
      new TwigFunction('get_view', 'views_embed_view'),
    ];
  }
